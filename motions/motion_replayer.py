...
def test_filepath():
    """Simple test function to verify filepath input/output"""
    filepath = input("Enter a filepath to test: ")
...
def main():
    ...
    parser.add_argument("--motion", type=str, default="./motions/G1_dance.npz")
    ...
    parser.add_argument("--test", action="store_true", help="Run filepath test only")
    args_cli = parser.parse_args()

    # If test flag is set, just run the test
    if args_cli.test:
        test_filepath()
        return
